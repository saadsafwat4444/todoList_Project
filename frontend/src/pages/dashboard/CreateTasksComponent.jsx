...
export function CreateTasksComponenet(){
  ...
  onSubmit(data);
    ...
    <div className="p-6 bg-slate-50 min-h-screen">
      <h1 className="text-3xl font-bold text-slate-800 mb-6">Create New Task</h1>

      <form onSubmit={handleSubmit(onFormSubmit)} className="bg-white p-6 rounded shadow-md  space-y-4">
        {/* Title */}
        <div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
         className={`w-full px-4 py-2 border border-slate-300 rounded focus:outline-none focus:ring-2 
                ${errors.desc?"border-red-400 focus:ring-red-800":"border-slate-300 focus:ring-blue-500"}`}            {...register('desc',{
   ...
   className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 ${
              errors.status ? "border-red-500 focus:ring-red-500" : "border-slate-300 focus:ring-blue-500"
            }`}
            > 
        ...
        <div>
          ...
          <select  
                    {...register("priority", { required: "Priority is required" })}
                      className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 ${
              errors.priority ? "border-red-500 focus:ring-red-500" : "border-slate-300 focus:ring-blue-500"
            }`}
        ...
        <div>
          ...
          <label className="block text-slate-700 font-medium mb-1">Created At</label>
          <input
            type="date"
                {...register("createdAt", { required: "Date is required" })}

            className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 ${
              errors.createdAt ? "border-red-500 focus:ring-red-500" : "border-slate-300 focus:ring-blue-500"
            }`}          />
        </div>
